...
public class SearchSeriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText=findViewById(R.id.no_of_episodes);
        ...
        fetchSeries(search_bar.new_search);
        ...
        gobackx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SearchSeriesActivity.this, homepage.class);
    ...
    private void fetchSeries(String movie_name) {

        String movie_url = "https://api.themoviedb.org/3/search/tv?api_key=46dcf0c9bfcce3c007dbf3d56df98402&language=en-US&query=";
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET,url, null, new Response.Listener<JSONObject>(){
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0 ; i < movie_list.length() ; i ++){
                        ...
                        Movie movie = new Movie(title , poster , overview , rating, ID,"1");
                        movieList.add(movie);
                    }

                    MovieAdapter adapter = new MovieAdapter(SearchSeriesActivity.this , movieList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(SearchSeriesActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
